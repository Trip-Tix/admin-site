import {
  ...
  interface TrainCardProps {
    ...
    submit: boolean;
    updateCoachLength: (length: number) => void;
  ...
  export default function TrainCard({
    ...
    useEffect(() => {
      ...
      updateCoachLength(selectedCoaches.length == coachForms.length ? selectedCoaches.length : 0);
    }, [selectedCoaches, coachForms, updateCoachLength]);
    ...
    }, [cols, facilities, fetchedLayouts, fetchedNumSeats, layouts, numSeats, numTrain, rows, selectedCoaches, submit, uniqueTrainId]);
